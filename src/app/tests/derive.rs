//! Tick / sweep / re-derivation / adoption tests (§7.2, §7.3), plus the §6
//! attention facts that ride on a derivation: the held acknowledgement and what
//! a conversation's classified rest does to the strip.
