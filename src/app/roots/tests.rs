...
fn the_roots_are_folded_from_the_world_and_nothing_else() {
    ...
    assert_eq!(roots.lernie_data, PathBuf::from("/w/lernie"));
    ...
    assert_eq!(roots.workspaces(), PathBuf::from("/w/lernie/workspaces"));
    assert_eq!(roots.replays(), PathBuf::from("/w/lernie/replays"));
