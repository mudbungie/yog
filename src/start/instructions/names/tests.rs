...
fn a_workspace_with_no_override_reads_the_default() {
    ...
    assert_eq!(names(&ws, "default"), vec!["AGENTS.md".to_owned()]);
    ...
    assert_eq!(names(&seeded, "default"), vec!["AGENTS.md".to_owned()]);
}
...
fn a_committed_override_replaces_the_default_in_its_own_order() {
    ...
    assert_eq!(names(&ws, "default"), vec!["HOUSE.md", "AGENTS.md"]);
}
