...
/// **The engine's own prose on this leg** (REMOTE §5.6): the refusal an
/// unheld handle earns, the capture an exhausted lease is answered with, and
/// the mark a redelivered one carries.
mod doubt;
