...
pub(super) fn turn_key(first_key: &str) -> String {
    let entry = first_key
        .rsplit_once('#')
...
/// **What a rolled-up turn holds** — the census and the sentence it says; its
/// own file per §12's budget.
mod counts;
use counts::Counts;
