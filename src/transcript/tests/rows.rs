//! The §11 one-line row projection: classification and the preview/body split.
//! Which rows arrive open — the derived auto-state, its two knobs and the
//! explicit-override flip — is [`auto`], split off at the cap.
